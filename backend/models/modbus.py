...
class ModbusResponse(BaseResult):
    ...
    request_id: Mapped[int] = mapped_column(Integer, ForeignKey("modbus_request.item_id", ondelete="SET NULL"), nullable=True, default=None)  # Do not delete on cascade because parent result will show incorrect results
