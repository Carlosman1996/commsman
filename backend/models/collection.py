...
class CollectionResult(BaseResult):
    ...
    request_id: Mapped[int] = mapped_column(Integer, ForeignKey("collection.item_id", ondelete="SET NULL"))  # Do not delete on cascade because parent result will show incorrect results
